...
icl_hash_t *icl_hash_create(int nbuckets, unsigned int (*hash_function)(void *),
  ...
  ht->hash_key_compare = hash_key_compare ? hash_key_compare : ulong_key_compare;
 ...
 */
int icl_hash_delete(icl_hash_t *ht, void *key, void (*free_key)(void *),
                    void (*free_data)(void *)) {
 ...
 * @returns 0 on success, -1 on failure.
 */
int icl_hash_destroy(icl_hash_t *ht, void (*free_key)(void *),
                     void (*free_data)(void *)) {
